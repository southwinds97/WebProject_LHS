      ...
      <div class="contents">
        <div class="inner">
          ...
          <div class="board_list view">
            <table>
              <caption>KOPRI 청렴게시판 테이블</caption>
              <thead>
                <tr>
                  <th class="th_view">
                    <div class="th_tit">
                      <p>${ dto.title }</p>
                      <ul class="info">
                        <li class="info_count">조회수: ${ dto.visitcount }</li>
                        <li class="info_wrt">작성자: ${ dto.name }</li>
                        <li class="info_wrt">작성일: ${ dto.postdate }</li>
                      </ul>
                    </div>
                    <div class="dl_wrap">
                      <ul class="dl_file">
            ...
            <div class="board_btn">
			    <c:if test="${ dto.id eq sessionScope.user_id }">
			        ...
			        <button type="button" style="background:black; color:white;" onclick="location.href='pass.do?mode=delete&idx=${ param.idx }&board_type=${board_type}';">
			            삭제
			        </button>
			    </c:if>
				<a href="List.do?board_type=${board_type}" class="list_btn">목록</a>
			</div>
          </div>
          <div class="comment_write">
            <jsp:include page="CommentWrite.jsp" >
            	<jsp:param name="postnum" value="${param.idx}" />
			    <jsp:param name="id" value="${id}" />
			    <jsp:param name="name" value="${name}" />
			    <jsp:param name="board_type" value="${param.board_type}" />
            </jsp:include>
          </div>
