...
<body>
  ...
  <div id="wrap">
    <header id="header">
      <div class="inner">
        <h1 class="logo"> <a href="index.jsp"> <img src="images/logo.png" alt="극지연구소"> </a> </h1>
        <nav class="gnb_wrap">
          <ul class="gnb">
            <li> <a href="#"> KOPRI </a>
    ...
    <main id="container" class="release sub_container">
      <div class="sub_top">
        <div class="inner">
          <div class="sub_tit">
            <h2><strong>소통·참여</strong>KOPRI 청렴게시판</h2>
              ...
              <li>
                ...
                <li>
                  ...
                  <ul class="sub_depth2">
                    ...
                    <li><a href="#">고객참여</a></li>
                    <li><a href="#">자료실</a></li>
                    <li><a href="#" target="_blank" title="새창으로 이동" class="a_target">극지연구소<br>메타버스</a></li>
                  </ul>
                </li>
            </ul>
            <div class="sub_link">
      ...
      <aside class="release_menu">
        <div class="release_gnb_wrap">
          <ul class="release_gnb">
            ...
            <li><a href="#" target="_blank" title="새창으로 이동" class="a_target">극지연구소 메타버스</a></li>
          </ul>
        </div>
      ...
      <div class="contents">
        <div class="inner">
          ...
          <form name="writeFrm" method="post" enctype="multipart/form-data" 
                ...
                <tr>
                  <th class="th_view">
                    ...
                    <input type="hidden" name = "board_type" value="${ board_type }" />
                      <div style="text-align: left; border-bottom:1px solid #cdbdbd">
                      제목 : <input type="text" name="title" style="border:none;"/>
                      </div>
                      <ul class="info">
                        <li class="info_wrt">작성자: ${name}
            ...
            <div class="board_btn" style="display:flex; justify-content: center;">
	            <button type="submit" style="background:black; color:white; margin-right:5px; padding:10px;">작성 완료</button>
	            <button type="reset" style="background:black; color:white; margin-right:5px; padding:10px;">RESET</button>
	            <button type="button" onclick="location.href='List.do';" style="background:black; color:white; padding:10px;">
	                목록 바로가기
	            </button>
            </div>
            </form>
